...
function Colors() {
  const colors = [
    { id: "blue", name: "Titânio Azul", image: blueImg, colorClass: "bg-blue-500" },
    { id: "silver", name: "Titânio Natural", image: silverImg, colorClass: "bg-gray-300" },
    { id: "orange", name: "Titânio Laranja", image: orangeImg, colorClass: "bg-orange-500" },
  ];

  const models = [
    { name: "Pro Max", screen: "6.9 polegadas", storage: "256GB, 512GB ou 1TB", batery: "33h de vídeo", weight: "221g" },
    { name: "Pro", screen: "6.3 polegadas", storage: "256GB, 512GB ou 1TB", batery: "29h de vídeo", weight: "199g" },
  ];
    ...
    <section id="cores" className="bg-black py-20 px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-16">
            <button className="bg-blue-700 hover:bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-medium transition-all duration-300 mb-2 hover:scale-105 shadow-md shadow-blue-500/50 cursor-pointer">Compre agora a partir de R$ 9.299,00</button>
            <p>Ou em até 12x de R$ 997,05</p>
        </div>
      </div>
    </section>
  );
