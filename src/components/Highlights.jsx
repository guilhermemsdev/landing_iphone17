import designImg from '../assets/titanium-design.jpg'
import iosImg from '../assets/ios-features.jpg'
import chipImg from '../assets/chip-a18-pro.jpg'
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mb-16">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src={designImg} alt="iphone-titanium" />
                    ...
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src={iosImg} alt="ios 2026" />
                        <h3 className="font-bold mb-2 text-3xl">IOS 26</h3>
                        <p className="text-gray-300">O sistema operacional mais avançado com IA integrada.</p>
                    </div>
                </div>
                ...
                <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="performance">
                    ...
                    <img className="w-full rounded-2xl mb-4" src={chipImg} alt="chip a18 pro" />
                ...
                <div className="text-center" id="camera">
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        ...
                        <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 cursor-pointer transition-all duration-300">                        
                            ...
                            <h4 className="text-xl font-semibold mb-2">Telefoto</h4>
